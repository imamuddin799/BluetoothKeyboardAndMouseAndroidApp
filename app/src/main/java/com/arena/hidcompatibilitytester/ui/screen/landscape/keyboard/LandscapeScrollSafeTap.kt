...
suspend fun PointerInputScope.landscapeScrollSafeTap(
...
suspend fun PointerInputScope.landscapeRepeatScrollSafeTap(
    scope: CoroutineScope,
    slopPx: Float = 18f,
    repeatMe: Boolean = false,
    initialDelayMs: Long = 400L,
    ...
    while (true) {
        landscapeScrollSafeTap(scope, slopPx, repeatMe, initialDelayMs, repeatIntervalMs, onTap)
    }
}