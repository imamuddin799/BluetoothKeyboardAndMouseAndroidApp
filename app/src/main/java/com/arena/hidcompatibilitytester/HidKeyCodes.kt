...
object HidKeyCodes {
    ...
    const val KEY_D = 0x07; const val KEY_E = 0x08; const val KEY_F = 0x09
    const val KEY_G = 0x0A; const val KEY_H = 0x0B; const val KEY_I = 0x0C
    const val KEY_J = 0x0D; const val KEY_K = 0x0E; const val KEY_L = 0x0F
    const val KEY_M = 0x10; const val KEY_N = 0x11; const val KEY_O = 0x12
    const val KEY_P = 0x13; const val KEY_Q = 0x14; const val KEY_R = 0x15
    const val KEY_S = 0x16; const val KEY_T = 0x17; const val KEY_U = 0x18
    ...
    const val KEY_F4  = 0x3D; const val KEY_F5  = 0x3E; const val KEY_F6  = 0x3F
    const val KEY_F7  = 0x40; const val KEY_F8  = 0x41; const val KEY_F9  = 0x42
    const val KEY_F10 = 0x43; const val KEY_F11 = 0x44; const val KEY_F12 = 0x45

    // Navigation
    const val KEY_PRINT_SCREEN = 0x46; const val KEY_SCROLL_LOCK = 0x47
    const val KEY_PAUSE        = 0x48; const val KEY_INSERT      = 0x49
    const val KEY_HOME         = 0x4A; const val KEY_PAGE_UP     = 0x4B
    const val KEY_DELETE       = 0x4C; const val KEY_END         = 0x4D
    const val KEY_PAGE_DOWN    = 0x4E; const val KEY_RIGHT       = 0x4F
    const val KEY_LEFT         = 0x50; const val KEY_DOWN        = 0x51
